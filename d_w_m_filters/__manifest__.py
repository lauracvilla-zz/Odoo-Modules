# -*- coding: utf-8 -*-
{
    'name' : "Today, Last week, Last month filters",
    'version' : "1.0",
    ...
    'data': ['views/so_f_d_w_m.xml', 'views/po_f_d_w_m.xml', 'views/inv_f_d_w_m.xml', 'views/acc_f_d_w_m.xml', 'views/pay_f_d_w_m.xml'],
